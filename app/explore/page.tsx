...
const page = async () => {
  ...
  // const songLostTop10 = await getSongListTop10();

  const [playlistArray, songLostTop10] = await Promise.all([getAllPlaylist(), getSongListTop10()]);
  ...
  return (
    <PagePadding>
      ...
      <div className="mt-20"></div>
      <SongListCarousel songListTop10={songLostTop10} title="인기곡" />
      <div className="mt-20"></div>
